            ...
            <div class="card-body p-5">
              ...
              <form action="<%=request.getContextPath() %>/register" method="post">
                ...
                <div class="form-outline mb-4">
                    ...
                    <input type="text" id="dt" name="dt" class="form-control form-control-lg" />
                ...
                <p class="text-center text-muted mt-5 mb-0">Bạn đã có tài khoản? <a href="<%= request.getContextPath() %>/login" class="fw-bold text-body"><u>Đăng nhập</u></a></p>
              </form>
            </div>
          </div>
        </div>
...
<script type="text/javascript">
		...
		if(status == "failed"){
			swal("Sorry","Sorry, Username is taken","error");
		}
		else if(status == "usernameInvalid"){
